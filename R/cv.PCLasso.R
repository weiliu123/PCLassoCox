...
#'
#' @param x A n x p design matrix of gene expression measurements with n samples and p genes, as in \code{PCLasso}.
#' @param y The time-to-event outcome, as a two-column matrix or \code{Surv} object, as in
...
#' @param group A list of groups as in \code{PCLasso}. The feature (gene) names in \code{group}
#' should be consistent with the feature (gene) names in \code{x}.
#' @param penalty The penalty to be applied to the model. For group selection, one of grLasso,
...
#' @param standardize Logical flag for \code{x} standardization, prior to fitting the model.
#' Default is \code{TRUE}.
#' @param ... Arguments to be passed to \code{cv.grpsurv} in the R package \code{grpreg}.
#'
